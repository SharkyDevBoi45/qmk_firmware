...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        KC_F1,    KC_1,       KC_2,       KC_3,     KC_4,     KC_5,   KC_6,    KC_7,   KC_8,    KC_9,       KC_0,      KC_MINS,    KC_EQL,    KC_NO,     KC_BSPC,
        ...
        KC_ESC,   KC_LSFT,    KC_Z,       KC_X,     KC_C,     KC_V,   KC_B,    KC_N,   KC_M,    KC_COMM,    KC_DOT,    KC_SLSH,    KC_RSFT,
